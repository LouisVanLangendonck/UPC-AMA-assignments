...
From this experiment, the leave-one-out cross-validation max log likelihood method selects b = `r`b_optimal\` as the optimal value for b (out of the proposed values for b). The corresponding histogram can be found below.
