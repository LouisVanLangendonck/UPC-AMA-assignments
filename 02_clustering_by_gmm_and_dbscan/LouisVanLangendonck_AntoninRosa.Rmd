...
Comparing these plots, it becomes clear both show a similar profile. However the GMM model (left) yields a clear distinction in three gaussian shapes (as typically predicted in this type of model), while the non-param model (right) shows more arbitrary outlines. This is due to the fact that in the first case, the data is fit to the model (mixture of three gaussians) and the plot is a visual representation of these three gaussians, while the second plot is a direct representation of the data density, and thus less regular.
